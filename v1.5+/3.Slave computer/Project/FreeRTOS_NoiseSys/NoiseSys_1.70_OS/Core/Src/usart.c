...
void HAL_UART_MspInit(UART_HandleTypeDef *uartHandle)
{
    ...
    else if (uartHandle->Instance == USART2)
    {
        ...
        PA3     ------> USART2_RX
        */
        GPIO_InitStruct.Pin = NOISE_TX_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
        HAL_GPIO_Init(NOISE_TX_GPIO_Port, &GPIO_InitStruct);

        GPIO_InitStruct.Pin = NOISE_RX_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        HAL_GPIO_Init(NOISE_RX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef *uartHandle)
{
    ...
    else if (uartHandle->Instance == USART2)
    {
        ...
        PA3     ------> USART2_RX
        */
        HAL_GPIO_DeInit(GPIOA, NOISE_TX_Pin | NOISE_RX_Pin);
