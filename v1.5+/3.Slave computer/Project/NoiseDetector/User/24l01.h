...
#define NRF24L01_CSN_0 HAL_GPIO_WritePin(NSS_GPIO_Port, NSS_Pin, GPIO_PIN_RESET); // SPI片选信号
#define NRF24L01_CSN_1 HAL_GPIO_WritePin(NSS_GPIO_Port, NSS_Pin, GPIO_PIN_SET);   // SPI片选信号
