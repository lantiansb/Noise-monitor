#ifndef __DRV_RF24L01_H
#define __DRV_RF24L01_H
...
/** RF24L01硬件IO定义 */
#define RF24L01_CE_GPIO_PORT			2
#define RF24L01_CE_GPIO_PIN				6

#define RF24L01_IRQ_GPIO_PORT			3
#define RF24L01_IRQ_GPIO_PIN			2

#define RF24L01_CS_GPIO_PORT			1			//PB4
#define RF24L01_CS_GPIO_PIN				4

/** 口线操作函数定义 */
#define RF24L01_SET_CE_HIGH( )			Gpio_SetIO( RF24L01_CE_GPIO_PORT, RF24L01_CE_GPIO_PIN,1 )
#define RF24L01_SET_CE_LOW( )			Gpio_SetIO( RF24L01_CE_GPIO_PORT, RF24L01_CE_GPIO_PIN ,0)

#define RF24L01_SET_CS_HIGH( )			SPIx_NSS_HIGH( )
#define RF24L01_SET_CS_LOW( )			SPIx_NSS_LOW( )

#define RF24L01_GET_IRQ_STATUS( )		Gpio_GetIO( RF24L01_IRQ_GPIO_PORT,RF24L01_IRQ_GPIO_PIN )
