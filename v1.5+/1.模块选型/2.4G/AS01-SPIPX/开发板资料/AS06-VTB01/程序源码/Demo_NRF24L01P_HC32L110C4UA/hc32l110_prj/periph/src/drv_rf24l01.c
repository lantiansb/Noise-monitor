...
{
	//CE配置为推挽输出 IRQ上拉输入
	Gpio_InitIOExt( RF24L01_CE_GPIO_PORT, RF24L01_CE_GPIO_PIN, GpioDirOut,TRUE, FALSE, FALSE, FALSE);
	Gpio_InitIOExt( RF24L01_IRQ_GPIO_PORT, RF24L01_IRQ_GPIO_PIN, GpioDirIn,TRUE, FALSE, TRUE, FALSE);
